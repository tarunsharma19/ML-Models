...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Sign Language Learner")
        ...
        self.T.config(text = "Sign Language Learner Test", font = ("Courier", 30, "bold"))
        ...
        self.T3.config(text = "Question : Sign ABCD",font = ("Courier", 30, "bold"))
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            if len(self.word)>1 and self.word[-4:] == self.answer[-1]:
                self.bt1.config(text ="Correct Answer", font = ("Courier", 20),bg='green')
            elif len(self.word)>1:
                self.bt1.config(text ="Wrong Answer", font = ("Courier", 20),bg='yellow')

            # else:
            #     self.bt1.config(text = "Wrong Answer", font = ("Courier", 20))
